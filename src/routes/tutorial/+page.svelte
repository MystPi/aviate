...
<main>
  <Prose>
    ...
    <h2>Components</h2>
    <p>
      Components consist of a name, like <code>followers</code> or <code>add</code>, then a list of
      <em>arguments</em>
    ...
    <p>
      Since strings could be anything in the world, there are two <em>special types</em> of strings that
      are used by some components. They are the abbreviated names of forums, and the names of statistic
      categories. That sounds confusing, but it really isn't. Take a look:
    </p>
